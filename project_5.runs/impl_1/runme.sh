...
HD_PWD='C:/Vivado/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Syn_Asy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Syn_Asy.tcl -notrace
