...
HD_PWD='C:/Vivado/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Syn_Asy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Syn_Asy.tcl
